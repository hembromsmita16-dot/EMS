  ...
  return (
    ...
    overflow-hidden shadow-sm hover:shadow-md transition">
      ...
      <div className="p-3">
        ...
        bg-slate-100 text-[11px] font-medium text-slate-600">
      ...
      <div className="h-28 bg-slate-50 flex items-center justify-center">
        <div className="w-14 h-14 rounded-full bg-indigo-50
      ...
      <div className="p-4 flex items-center justify-between">
        ...
        opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <button
            ...
            hover:text-indigo-600 flex items-center justify-center"
          >
            <Pencil size={16} />
          </button>
